...
if __name__ == '__main__':
    ...
    #     Do you know 'Titanic' datased from Kaggle - If yes, tell me how many people survied.  ''')
    # print(res)

    # create sqlite wdb from Titanic dataset 
    ...
    def tool_schema(tables: str) -> str:
        '''Get all tables schema. Example input: table1, table2, table3'''
